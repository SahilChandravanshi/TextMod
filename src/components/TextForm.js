...
export default function TextForm(props) {
  ...
  return (
    <>
      <div
        className="container"
        style={{ color: props.mode === "dark" ? "white" : "#1f2023" }}
      >
        <h2>{props.heading}</h2>
        <div className="mb-3">
          <input
          ...
          <textarea
            ...
            style={{
              backgroundColor: props.mode === "dark" ? "#1f2023" : "white",
              color: props.mode === "dark" ? "white" : "#1f2023",
            }}
          ></textarea>
        </div>
        <button
        ...
        <button className="btn btn-primary mx-2 my-2" onClick={rot13}>
          Convert ROT13
        </button>
